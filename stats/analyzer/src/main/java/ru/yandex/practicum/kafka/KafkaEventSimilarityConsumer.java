...
import deserializer.impl.EventSimilarityDeserializer;
...
@Component
public class KafkaEventSimilarityConsumer {
    ...
    private KafkaConsumer<String, SpecificRecordBase> getConsumer() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "SimilaritiesAnalyzer");
